...
<template>
  <div class="crud">
  <div><p class="font-semibold mt-2">CRUD operation using Vue3, Tailwind, LocalStorage</p></div>
    <div class="ml-auto mr-auto max-w-3xl mt-20 h-full">
      <div class="w-full flex justify-end">
        <RouterLink to="/new" class="flex text-sm bg-green-800 mb-1 hover:bg-neutral-600 font-bold items-center pb-2 pt-2 rounded-sm text-white pl-3 pr-3"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16"> <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/> <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/> </svg>Add Student</RouterLink>
      </div>
      <table class="text-left text-md font-light table-fixed shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
        ...
        <tbody>
          ...
          <tr v-for="student in Students" :key="student.id"
            class="border-b hover:bg-neutral-100 bg-white dark:border-neutral-500 dark:bg-neutral-700"
          >
